        ...
        if model_options.dense_prediction_cell_config is not None:
            ...
            with slim.arg_scope(
                ...
                with slim.arg_scope([batch_norm], **batch_norm_params):
                    ...
                    mult_rate = 1
                    dropout = False
                    simple_res, simple_res_array = simple_net(softmax, model_options, weight_decay,
                                                              reuse, kernel_init, use_batch_norm,
                    ...
                    aspp0_res = slim.conv2d(features, depth, 1, scope=ASPP_SCOPE + str(0))
                    aspp_concat0 = tf.concat([simple_res, aspp0_res], 3)
                    branch_logits.append(aspp_concat0)
                    ...
                    if model_options.atrous_rates:
                        ...
                        for i, rate in enumerate(model_options.atrous_rates, 1):
                            ...
                            simple_net_layer_res = tf.image.resize_bilinear(simple_res_array[simple_index],
                                                                            tf.shape(aspp_features)[1:3])

                            aspp_features = tf.concat([simple_net_layer_res, aspp_features], 3)
    ...
    with slim.arg_scope(
        ...
        with slim.arg_scope([batch_norm_fn], **batch_norm_params):
            with tf.variable_scope(SIMPLE_NET_SCOPE, SIMPLE_NET_SCOPE, [softmax]):
                ...
                simple_res_array.append(simple_res)
                ...
                return simple_res, simple_res_array
